...
export const TOOL_CATALOG: Record<string, ToolDefinition> = {
  ...
  // --- Operator read-only inspection tools ---
  "logs.describe": {
    name: "logs.describe",
    version: "1",
    input_schema: { type: "object", properties: { log_group_name: { type: "string" }, log_stream_prefix: { type: "string" } } },
    output_schema: { type: "object", properties: { log_groups: { type: "array" } } },
  ...
  "logs.search": {
    name: "logs.search",
    version: "1",
    input_schema: { type: "object", properties: { log_group_name: { type: "string" }, filter_pattern: { type: "string" }, start_time: { type: "string" }, end_time: { type: "string" } } },
  ...
  "logs.read": {
    name: "logs.read",
    version: "1",
    input_schema: { type: "object", properties: { log_group_name: { type: "string" }, log_stream_name: { type: "string" }, start_time: { type: "string" }, end_time: { type: "string" } } },
    output_schema: { type: "object", properties: { events: { type: "array" } } },
    permissions: ["logs:read"],
    mutation_level: "read",
    emits_evidence: true,
  ...
  "ecs.list_tasks": {
    name: "ecs.list_tasks",
    version: "1",
    input_schema: { type: "object", properties: { cluster: { type: "string" }, desired_status: { type: "string" } } },
    output_schema: { type: "object", properties: { task_arns: { type: "array" } } },
    permissions: ["ecs:read"],
    mutation_level: "read",
    emits_evidence: true,
    categories: ["read"],
  },
  "ecs.describe_task": {
    name: "ecs.describe_task",
    version: "1",
    input_schema: { type: "object", properties: { cluster: { type: "string" }, task_arn: { type: "string" } } },
  ...
  "s3.list_task_artifacts": {
    name: "s3.list_task_artifacts",
    version: "1",
    input_schema: { type: "object", properties: { bucket: { type: "string" }, prefix: { type: "string" } } },
    output_schema: { type: "object", properties: { keys: { type: "array" } } },
    permissions: ["s3:read"],
    mutation_level: "read",
    emits_evidence: true,
    categories: ["read"],
  ...
  "s3.read_task_metadata": {
    name: "s3.read_task_metadata",
    version: "1",
    input_schema: { type: "object", properties: { bucket: { type: "string" }, key: { type: "string" } } },
  ...
  "github.read_issue": {
    ...
    version: "1",
    input_schema: { type: "object", properties: { repo: { type: "string" }, issue_number: { type: "number" } } },
